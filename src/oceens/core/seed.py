...
# Données de seed (CSV), résolues depuis le paquet, pas depuis le dossier courant
...
def seed_users(session: Session):
    ...
    user_data = [
        ...
        *ADDITIONAL_STUDENT_USERS,
        # Un utilisateur par rôle unique (#84)
        (23, "oceens.facilitator@epf.fr"),
        (24, "oceens.programmanager@epf.fr"),
        (25, "oceens.campusmanager@epf.fr"),
    ]
